...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Carlos Ortiz - DIICC UDA</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="teacher-details-content ml-50">
                            <h2>Carlos Ortiz</h2>
                            <h5>Ingeniero en Sitemas</h5>
                            <h4></h4>
                            <p> </p>
                            <ul>
                                <li><span>Grado Académico: </span>
</li>
                                <li><span>Áreas de interés: </span>
</li>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <div class="teacher-contact">
                            ...
                            <p><span>Correo: </span>carlos.ortiz@uda.cl</p>
                            <p><span>FONO: </span>(52) 3333333</p>
