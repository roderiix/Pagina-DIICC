...
?>
    <body>
	    ...
	    <div class="banner-area-wrapper">
            <div class="banner-area text-center"><!--Para cambiar la imagen del banner,ir a style.css,linea 172 y modificar la direccion de la imagen(1920x318)-->	
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4|" id="detalles_dpto">
                                ...
                                <div class="table-bordered">          
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><p><span class="glyphicon glyphicon-chevron-right"></span> Auditorio</p></td>
        
                                            </tr>
                                            <tr>
                                                <td><p><span class="glyphicon glyphicon-chevron-right"></span> Sala Multimedia</p></td>
        
                                            </tr>
                                            <tr>
                                                <td><p><span class="glyphicon glyphicon-chevron-right"></span> Sala de Estudios</p></td>
        
                                            </tr>
                                            <tr>
                                                <td><p><span class="glyphicon glyphicon-chevron-right"></span> Sala Modular de Estudios</p></td>
        
                                            </tr>
                                            <tr>
                                                <td><p><span class="glyphicon glyphicon-chevron-right"></span> Dos Salas de Clases</p></td>
        
                                            </tr>
                                            <tr>
                                                <td><p><span class="glyphicon glyphicon-chevron-right"></span> Cuatro Laboratorios</p>
                                                    <p><span class="glyphicon glyphicon-pushpin"></span> Robotica</p><p><span class="glyphicon glyphicon-pushpin"></span> Conectividad y Redes</p>
