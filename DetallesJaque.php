...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Jaqueline Manríquez - DIICC UDA</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="teacher-details-content ml-50">
                            <h2>Jaqueline Manríquez Berrios</h2>
                            <h5>Profesor</h5>
                            <h4></h4>
                            <p> Recibió su grado de Magíster en Ingeniería Informática y Ciencias de la Computación de la Universidad de Atacama (Chile) en el 2016. Ella posee un Diplomado en Docencia Universitaria de la Universidad Católica del Norte en el 2017, además es Partner Moodle Certified Services Provider de la University Emprove (Mexico) en 2020 y posee certificación en docencia online del Instituto Profesional de Artes y Ciencias de la Comunicación, IACC (Chile). Recibió su grado de Ingeniero Ejecución en Computación e Informática de la Universidad Católica del Norte (Chile) en el 2005. Dentro de su área de interés ha realizado actualización de conocimientos en Desarrollo de servicios en la nube con HTML5, Javascript y node.js en la Universidad Politécnica Madrid (España), Flip Teaching metodología activa en la Universidad Politécnica Madrid (España), Data Science Programación Estadística con R en la Universidad Nacional Autónoma de México (México), Diseño de proyectos educativos innovadores con TIC en Universidad Tecnológica Nacional, Buenos Aires (Argentina), entre otros. Ella tiene 15 años de experiencia profesional en la educación superior en el área de la informática. Actualmente es profesor apoyo a la docencia en el Departamento de Ingeniería Informática y Ciencias de la Computación de la Universidad de Atacama y Docente de la Universidad Católica del Norte. Sus áreas de investigación de interés incluyen la ingeniería del software en el área de requisitos y la implementación de la docencia universitaria en el área de procesos, metodologías y estrategias.</p>
                            <ul>
