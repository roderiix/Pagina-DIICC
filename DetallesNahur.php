...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Nahur Melendez - DIICC UDA</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="teacher-details-content ml-50">
                            <h2>Nahur Melendez</h2>
                            <h5>Profesor</h5>
                            <h4></h4>
                            <p>NAHUR M. MELÉNDEZ ARAYA, es Ingeniero E. en Computación e Informática, graduado de la Universidad Católica del Norte, Antofagasta, Chile. Posee un Magíster en Ingeniería Informática de la Universidad Católica del Norte, Antofagasta, Chile. Actualmente, es académico del Departamento de Ingeniería Informática  y Ciencias de la Computación de la Universidad de Atacama. Es autor de publicaciones nacionales e internacionales, sobre temas de Ingeniería de Requisitos para productos de software y Computación aplicada. Además posee contribuciones literarias en libros especializados en las áreas atingentes a su disciplina. Posee 10 años de experiencia en docencia y consultoría. Es especialista en alta tecnología, Ingeniería Informática, primordialmente en Ingeniería de Requisitos para Productos de Software. Ha participado como conferencista en paneles, foros, seminarios, workshop y grupos de análisis a nivel ejecutivo, académicos y niveles de gobierno en temas relacionados con la alta tecnología, Ingeniería Informática, Ingeniería de Requisitos para Productos de Software., Productividad y Calidad. </p>
                            <ul>
