...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Vladimir Riffo - DIICC UDA</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="teacher-details-content ml-50">
                            <h2>Vladimir Riffo</h2>
                            <h5>Profesor</h5>
                            <h4></h4>
                            <p>Es Ingeniero Civil Industrial en Electrónica y recibió el grado de Licenciado en Ciencias de la Ingeniería  con Mención en Electrónica por la Universidad de Antofagasta, Antofagasta, Chile, en 1998. El grado de Magíster en Ingeniería, en 2011, y  el de doctor en Ciencias de la Ingeniería, en 2016, ambos de la Pontificia Universidad Católica de Chile (PUC), Santiago de Chile. Actualmente es Profesor Asociado del Departamento de Ingeniería Informática y Ciencias de la Computación de la Universidad de Atacama, Copiapó, Chile, donde ha sido Director en los años  2017 y 2018. Es miembro de GRIMA, Grupo de Inteligencia de Máquina, PUC. Sus intereses actuales de investigación incluyen reconocimiento de patrones, detección de objetos, inspección visual automática, visión por computadora usando múltiples vistas y ensayos con rayos X, y la forma de combinar esos enfoques. Recibió una beca de la Comisión Nacional de Investigación Científica y Tecnológica (CONICYT) para cursar estudios de Doctorado y fue galardonado con el premio Ron Halmshaw en 2012 y el Premio John Green en 2013 por el Instituto Británico de Ensayos No Destructivos, que se estableció para los mejores trabajos publicados en la Revista Insight sobre Radiografía Industrial.</p>
                            <ul>
