...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Hector Cornide Reyes - DIICC UDA</title>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-5 col-xs-12">
                        <div class="teacher-details-img">
                            <img src="img/academicos/img10.jpg" alt="teacher">  
                        </div>
                        <style type="text/css">
                            table, th, td{
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="teacher-details-content ml-50">
                            <h2>Hector Cornide Reyes</h2>
                            <h5>Profesor</h5>
                            <h4></h4>
                            <p> </p>
                            <ul>
                                <li><span>Grado Academico: </span>Ingeniero Civil en Computación e Informática, Universidad de Atacama, 2004. <br>Licenciado en Ciencias de Ingeniería, Universidad de Atacama, 2003.
</li>
                                <li><span>Areas de interes: </span>
</li>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <div class="teacher-contact">
                            ...
                            <p><span>Correo: </span>hector.cornide@uda.cl</p>
