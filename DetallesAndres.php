...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Andrés Alfaro - DIICC UDA</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="teacher-details-content ml-50">
                            <h2>Andres Alfaro</h2>
                            <h5>Profesor</h5>
                            <p>Andrés Alfaro Avalos, es Magister en Informática y Ciencias de la Computación, Ingeniero de Ejecución en Computación e Informática, Licenciado en Ciencias de la Ingeniería y Técnico en
Análisis y Programación de Sistemas Computacionales de la Universidad de Atacama. Actualmente
es, académico del Departamento de Ingeniería Informática y Ciencias de la Computación de la
Universidad de Atacama y cumpliendo labores como tutor de cohorte y de vinculación con el
