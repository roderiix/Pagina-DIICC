...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Manuel Monasterio - DIICC UDA</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="teacher-details-content ml-50">
                            <h2>Manuel Monasterio</h2>
                            <h5>Profesor</h5>
                            <h4></h4>
                            <p> MANUEL MONASTERIO CORTÉS,  es Magíster en Informática Educativa, Licenciado en Ciencias de la Ingeniería e Ingeniero en Ejecución en Computación e Informática de la Universidad de Atacama. Actualmente se desempeña como académico en este Departamento. Desde 2004 hasta la fecha ha trabajado como relator de cursos de capacitación en herramientas ofimáticas de productividad para importantes empresas regionales, además de ocupar cargos directivos en su área de investigación. Ha impartido una serie de asignaturas dentro de su ámbito, tales como Procesamiento de Datos, Arquitectura de Sistemas Computacionales, Sistemas Operativos, entre otros, y desde 2011 al 2019  a Director de Aseguramiento de la Calidad de nuestra universidad. Actualmente es Profesor Asistente del Departamento de Ingeniería Informática y Ciencias de la Computación de la Universidad de Atacama.</p>
                            <ul>
